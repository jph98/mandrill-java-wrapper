...
public class MandrillMessage {
    ...
    private List<MandrillMergeVar> global_merge_vars;
    ...
    public List<MandrillMergeVar> getGlobal_merge_vars() {
    ...
    public void setGlobal_merge_vars(List<MandrillMergeVar> global_merge_vars) {
    ...
    public void setTo(List<MandrillRecipient> recips) {
        this.to = recips.toArray(new MandrillRecipient[recips.size()]);
    }
